...
central_corridor = Room("Central Corridor",
                        """
                           ...
                           mission is to get the neutron destruct bomb from the    
                           Weapons Armory, put it in the bridge, and blow the ship up after getting into escape pod.
                           You're running down the central corridor to the Weapons
                           Armory when a Gothon jumps out, red scaly skin, dark grimy teeth, and
...
laser_weapon_armory = Room("Laser Weapon Armory",
                           ...
                           code to get the bomb out. If you get the code wrong times then the
...
the_bridge = Room("The Bridge",
                  ...
                  gas out. You grab the neutron bomb and run as fast as you can to the bridge where you
